...
@Entity
@Table(name = "songs", uniqueConstraints = @UniqueConstraint(name = "uk_song_user_catalog_id", columnNames = {"user_id", "apple_catalog_id"}))
public class Song {
    ...
    public void setAppleCatalogId(Long value) { appleCatalogId = value; }
    public AppUser getOwner() { return owner; }
    public void setOwner(AppUser value) { owner = value; }
    public String getTitle() { return title; }
    public void setTitle(String value) { title = value; }
    public String getArtistName() { return artistName; }
    public void setArtistName(String value) { artistName = value; }
    public String getGenre() { return genre; }
    public void setGenre(String value) { genre = value; }
    public LocalDate getReleaseDate() { return releaseDate; }
    public void setReleaseDate(LocalDate value) { releaseDate = value; }
    public Integer getDuration() { return duration; }
    public void setDuration(Integer value) { duration = value; }
    public String getArtworkUrl() { return artworkUrl; }
    public void setArtworkUrl(String value) { artworkUrl = value; }
    public Integer getUserRating() { return userRating; }
    public void setUserRating(Integer value) { userRating = value; }
    public String getUserNotes() { return userNotes; }
    public void setUserNotes(String value) { userNotes = value; }
